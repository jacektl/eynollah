    ...
    if thickness_along_y_percent >= 14:
        ...
        for i in range(len(cx_text_only)):
            ...
            if x_width_mar > 16 and y_height_mar/x_width_mar < 18:
                marginals_should_be_main_text.append(polygons_of_marginals[i])
        ...
        # print(marginals_should_be_main_text,'marginals_should_be_main_text')
        text_regions = cv2.fillPoly(text_regions, pts=marginals_should_be_main_text, color=(4, 4))
